        ...
        <div class="max-w-5xl mx-auto px-6 lg:px-8">
            ...
            <div class="mb-10 flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                <div>
                    ...
                    <h1 class="text-3xl md:text-4xl font-black text-amber-700 tracking-tight">Manajemen Visi & Misi</h1>
                </div>
            </div>
        ...
        @enderror
            ...
            @if(!$isEdit)
                ...
                <div class="bg-white border border-amber-200/60 rounded-2xl p-8 shadow-sm space-y-6">
                    <div>
                        <h4 class="text-xs font-bold text-amber-800 uppercase mb-2">ℹ️ Informasi Halaman Visi & Misi</h4>
                        <p class="text-sm text-stone-600">Halaman Visi & Misi kini telah dioptimalkan dengan tata letak visual modern dan animasi yang menarik. Banner/header utama dapat diperbarui sewaktu-waktu melalui formulir pengunggahan di atas.</p>
                    </div>
                </div>
        </div>
    </div>

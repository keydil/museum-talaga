    ...
    <div class="min-h-screen bg-[#fdfbf2] py-8">
        <div class="mx-auto max-w-3xl px-4 sm:px-6 lg:px-8">
            ...
            <div class="rounded-2xl border border-amber-200/60 bg-white p-6 shadow-sm">
                <form action="{{ route('admin.walangsuji.update', $video->id) }}" method="POST" enctype="multipart/form-data" class="space-y-4 text-sm text-stone-700" onsubmit="handleFormSubmit(this)">
                    @csrf
                    @method('PUT')

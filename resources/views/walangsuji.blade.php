...
<body class="bg-amber-50 text-stone-900 antialiased font-sans min-h-screen flex flex-col">
    ...
    <div class="max-w-7xl mx-auto px-6 h-20 flex items-center justify-between gap-4">
        ...
        <nav class="hidden md:flex items-center space-x-6 text-xs md:text-sm font-medium text-stone-600 whitespace-nowrap ml-auto">
            <a href="#" hover:text-amber-700 transition">Beranda</a>
            ...
            <div class="relative inline-block text-left">
                 <button onclick="toggleDropdown(event, 'menuMuseum')" class="flex items-center {{ request()->routeIs('walangsuji') ? 'text-amber-600 font-semibold' : '' }} hover:text-amber-700 transition gap-1 focus:outline-none">
                ...
                <div id="menuMuseum" class="absolute left-0 mt-2 w-48 bg-white border border-amber-200 rounded-lg shadow-xl opacity-0 invisible -translate-y-2 transform transition-all duration-300 ease-out z-50 overflow-hidden text-left dropdown-list">
                    <a href="{{ route('walangsuji') }}" class="block px-4 py-2.5 text-xs {{ request()->routeIs('walangsuji') ? 'bg-amber-50 text-amber-600 font-bold border-l-4 border-amber-500' : 'text-stone-700' }} hover:bg-amber-50 hover:text-amber-800 border-b border-amber-100">Walang Suji</a>
    ...
    <div id="mobile-menu" class="hidden fixed top-20 left-0 right-0 md:hidden border-t border-amber-100 bg-white/95 px-6 py-4 space-y-3 text-sm font-medium text-stone-600 shadow-xl z-40 transition-all duration-300">
        ...
        <a href="{{ url('/') }}" wire:navigate class="hover:text-amber-700 py-1 transition">Beranda</a>
        ...
        <details class="group my-1">
            ...
            <div class="dropdown-content border-l border-amber-200 ml-1 pl-4 space-y-2.5 mt-2">
    <!-- HIGHLIGHT WALANG SUJI SELULER: Saat aktif, garis pembatas kiri menebal menjadi border-amber-500 dan teks bergeser sedikit ke kanan menggunakan -ml-[17px] pl-4 -->
    <a href="{{ route('walangsuji') }}" wire:navigate 
       class="block text-xs transition {{ request()->routeIs('walangsuji') ? 'text-amber-600 font-bold border-l-2 border-amber-500 -ml-[17px] pl-[15px]' : 'text-stone-500 hover:text-amber-700' }}">
       Walang Suji
    </a>
